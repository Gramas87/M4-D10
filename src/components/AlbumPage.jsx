...
//               <a href="homepage.html" className="text-white">
...
//           </div>
//     </section>
//             <div id="HomePageBody" className=" pl-4 col-md-10 px-0 mx-0">
//                <nav className="navbar navbar-expand-lg">
//               <div className="collapse navbar-collapse" id="navbarText">
//                 <ul className="navbar-nav mr-auto">
//                   <li className="nav-item active">
//                     <div className="nav-arrows-con">
//                       <a className="nav-link" href="#">
//                         <svg
//                           xmlns="http://www.w3.org/2000/svg"
//                           fill="currentColor"
//                           className="bi chevron bi-chevron-left"
//                           viewBox="0 0 16 16"
//                         >
//                           <path
//                             fill-rule="evenodd"
...
//                     <div className="nav-arrows-con disabled ml-3">
//                       <a className="nav-link" href="#">
//                         <svg
//                           xmlns="http://www.w3.org/2000/svg"
//                           fill="currentColor"
//                           className="bi chevron bi-chevron-right"
//                           viewBox="0 0 16 16"
//                         >
//                           <path
//                             fill-rule="evenodd"
...
//                   <div
//                     className="collapse navbar-collapse d-flex h-100"
//                     id="navbarNavDropdown"
//                   >
//                     <ul className="navbar-nav">
//                       <div className="dropdown profile d-flex">
//                         <a
//                           className="btn dropdown-toggle profile text-white justify-content-start dropdown-item1"
//                           href="#"
//                           role="button"
//                           id="dropdownMenuLink"
...
//                             className="img-fluid justify-content-start"
//                             id="profilePic"
//                             alt=""
//                           />
//                           <span className="profile">Diego "Ziba" Banovaz</span>
//                         </a>
//                       </div>
//                     </ul>
//                   </div>
...
//                     <a className="dropdown-item1" href="#">Account</a>
//                     <a className="dropdown-item1" href="#">Profile</a>
//                     <a className="dropdown-item1" href="#">Exit</a>
//                   </div>
//                 </span>
//               </div>
//             </nav>
...
//               {/* <!-- TITLE PART --> */}
//               <div className="artist-name-container" id="artist-name-cont">
//                 {/* <!-- GENERATED FROM JS  getAlbumDetails()  function -->    */}
//               </div>

//             {/* <!-- MIDDLE PART....ICONS --> */}
//           <div className="mt-5">
//           {/* <!--  <div className="position-relative">
//               <div className="whiteToPlay"></div> --> */}
//               <i className="bi bi-play-circle-fill"></i>
//             {/* <!-- </div> --> */}
//             <i className="bi bi-heart text-muted mx-4"></i>
...
//               </div>
//               <i className="bi bi-clock text-muted pr-5"></i> 
//             </div>

//             <hr className="mt-0 titleUnderline">

          
//               <div  className="songsList pl-0 text-muted" id="songList">

//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">1</span>
//                     <p className="pl-3 text-white">
//                       20th Century Fox Fanfare <br/>
//                       <span className="text-muted">Queen</span>
//                     </p>
//                   </div>
//                   <div>
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >0:23</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >4:55</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">3</span>
//                     <p className="pl-3 text-white">
//                       Doing All Right-...Revisited<br/>
//                       <span className="text-muted">Queen</span>
//                     </p>
//                   </div>
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3">3:16</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">4</span>
//                     <p className="pl-3 text-white">
//                       Keep Yourself Alive - Live At The Rainbow<br/>
//                       <span className="text-muted">Queen</span>
//                     </p>
//                   </div>
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >3:56</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">5</span>
//                     <p className="pl-3 text-white">
//                       Killer Queen<br/>
//                       <span className="text-muted">Queen</span>
//                     </p>
...
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >2:59</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">6</span>
//                     <p className="pl-3 text-white">
//                       Fat Bottomed Girls - Live In Paris<br/>
//                       <span className="text-muted">Queen</span>
//                     </p>
//                   </div>
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >4:37</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">7</span>
//                     <p className="pl-3 text-white">
...
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >5:54</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">8</span>
//                     <p className="pl-3 text-white">
//                       Now I'm Here - Live In The Hammersmith Odeon<br/>
//                       <span className="text-muted">Queen</span>
//                     </p>
//                   </div>
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >4:25</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>>
//                   </div>
//                 </div>
...
//                 <div className="pl-2 song d-flex justify-content-between">
//                   <div className="d-flex">
//                     <span className="listNumber">9</span>
//                     <p className="pl-3 text-white">
...
//                   <div >
//                     <i className="bi bi-heart hidden heartSong"></i>
//                     <span className="text-muted px-3" >2:43</span>
//                     <i className="bi bi-three-dots hidden threeDotsSong"></i>
//                   </div>
//                 </div>
...
//       <div
//         class="container-fluid m-music-player-section-height bg-dark d-flex justify-content-between"
//       >
